...
public class ArrayLoops05P146 {
    public static void main(String[] args) {
        ...
        // একটি নতুন 1D অ্যারে তৈরি করা হচ্ছে এবং সরাসরি মান দিয়ে পূরণ করা হচ্ছে
        int b[] = {1, 4, 3, 5, 7};
        ...
        for (int i = 0; i < a.length; i++) {
            ...
            System.out.println(a[i]);
            // এক লাইন ফাঁকা রেখে পরবর্তী উপাদান প্রিন্ট করার জন্য
            System.out.println();
...
একটি নতুন ক্লাস তৈরি করা হচ্ছে যার নাম ArrayLoops05P146।
public static void main(String[] args) {
...
b নামের একটি নতুন 1D অ্যারে তৈরি করা হচ্ছে এবং একে সরাসরি মান দিয়ে পূরণ করা হচ্ছে। এই অ্যারেটির 5টি উপাদান আছে: 1, 4, 3, 5, এবং 7।
for (int i = 0; i < a.length; i++) {
...
একটি ফাঁকা লাইন প্রিন্ট করা হচ্ছে যাতে পরবর্তী উপাদান প্রিন্ট করার আগে একটি ফাঁকা লাইন থাকে।
এই কোডটি অ্যারেতে সংখ্যাগুলি প্রিন্ট করবে একেকটি সংখ্যা একটি ফাঁকা লাইনের সাথে: 2, 6, 1, 9, এবং 12। আশা করি তুমি কোডটি ভালভাবে বুঝতে পেরেছো!
 */